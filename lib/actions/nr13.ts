...
export async function atualizarInspecaoNR13(
  ...
  const updateData: Record<string, any> = {
    ...
    data_emissao_laudo: form.dataEmissaoLaudo || null,
    ...
    proxima_inspecao_externa: form.proximaInspecaoExterna || null,
    proxima_inspecao_interna: form.proximaInspecaoInterna || null,
    data_proximo_teste_dispositivos: form.dataProximoTesteDispositivos || null,
