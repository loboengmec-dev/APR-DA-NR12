    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          {/* NR-13 — dois sub-módulos: Vasos de Pressão e Caldeiras */}
          <div className="group relative overflow-hidden rounded-2xl border-2 border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-slate-50 p-7 hover:border-emerald-300 hover:shadow-lg transition-all duration-200">
            <div className="absolute top-5 right-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-baseline gap-2">
                  <h3 className="text-lg font-bold text-gray-900">NR-13</h3>
                  <span className="text-sm text-gray-500">Vasos de Pressão e Caldeiras</span>
                </div>
                <p className="text-sm text-gray-500 mt-2 leading-relaxed">
                  Inspeção ASME Sec. VIII (vasos) e Sec. I (caldeiras), cálculo de PMTA em campo, medição de espessura e avaliação de PSV.
                </p>

                {/* Dois acessos distintos */}
                <div className="mt-4 pt-4 border-t border-emerald-100 grid grid-cols-2 gap-3">
                  <Link
                    href="/laudos/nr13/vasos"
                    className="flex items-center justify-between gap-2 rounded-lg border border-emerald-200 bg-white px-3 py-2.5 hover:bg-emerald-50 hover:border-emerald-300 transition-all"
                  >
                    <span className="text-sm font-semibold text-gray-800">Vasos de Pressão</span>
                  ...
                  <Link
                    ...
                    className="flex items-center justify-between gap-2 rounded-lg border border-orange-200 bg-white px-3 py-2.5 hover:bg-orange-50 hover:border-orange-300 transition-all"
                  >
                    <span className="text-sm font-semibold text-gray-800">Caldeiras</span>
                    <svg className="w-3.5 h-3.5 text-orange-600" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    </svg>
                  </Link>
                </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-800">Novo Vaso</p>
              <p className="text-xs text-gray-400">Inspeção NR-13</p>
            </div>
          </Link>

          <Link
            href="/laudos/nr13/caldeiras/novo"
            className="flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-orange-300 hover:bg-orange-50/40 transition-all duration-150 group shadow-sm"
          >
            <div className="w-9 h-9 rounded-lg bg-orange-100 flex items-center justify-center flex-shrink-0 group-hover:bg-orange-200 transition-colors">
              <svg className="w-5 h-5 text-orange-600" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
              </svg>
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-800">Nova Caldeira</p>
              <p className="text-xs text-gray-400">Inspeção NR-13</p>
            </div>
          </Link>
          ...
          <Link
            href="/perfil"
            className="flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-gray-300 hover:bg-gray-50 transition-all duration-150 group shadow-sm"
          >
